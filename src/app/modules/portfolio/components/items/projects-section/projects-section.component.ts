...
export class ProjectsSectionComponent {
  ...
  projects:any[]=[
    ...
    {projectName:"Go Travel WebSite Clone",technologies:"Angular",description:"Go Travel, Travelling Agency Web Site Clone Using Angular",gitLink:"https://github.com/Tasheela99/gotravel.git",imageLink:"/assets/images/project-images/travelling-website.png"},
